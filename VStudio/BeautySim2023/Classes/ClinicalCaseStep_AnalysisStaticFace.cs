...
{
    public class ClinicalCaseStep_AnalysisStaticFace : ClinicalCaseStep
    {
        public ClinicalCaseStep_AnalysisStaticFace() : base(Enum_ClinicalCaseStepType.ANALYSIS_STATIC_FACE)
        {
            if (ImScoreable)
            {
                Score = -1;
